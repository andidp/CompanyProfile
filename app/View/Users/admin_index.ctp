...
<div class="row">
            ...
            <table class="table table-bordered table-hover tablesorter">
                <thead>
                    <tr>
                                                    ...
                                                    <th><?php echo $this->Paginator->sort('group_id');?><i class="fa fa-sort"></i></th>
                                                    <th><?php echo $this->Paginator->sort('username');?><i class="fa fa-sort"></i></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink($this->Html->image('delete-icon-ios.png'), array('action' => 'delete', $user['User']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
                </tbody>
